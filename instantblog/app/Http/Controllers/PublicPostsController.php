...
class PublicPostsController extends Controller
{
    ...
    public function show(Post $post)
    {
        ...
        $random = Post::inRandomOrder()->wherePostLive(1)->first()->post_slug;

        $related = Post::inRandomOrder()->wherePostLive(1)->take(5)->get()->except($post->id);

        $pages = Page::orderBy('id', 'ASC') ->get();

        return view('public.show', compact('post', 'next', 'previous', 'random', 'related', 'pages'));
    }
    //Show archives posts
    ...
    public function facebookShow()
    {
        ...
        $related = Post::inRandomOrder()->wherePostLive(1)->take(4)->get();
