    ...
    <div class="row">
        <div class="col-md-8">     
            <div class="card">
                ...
                @elseif (!empty($post->user_id) AND Auth::id() == $post->user_id)
                <div class="card-header">
                    <div class="row">
                        <div class="col-8 text-muted">
                            {{ $post->user->name }} @lang('messages.yourpost')
                        </div>
                        <div class="col">
                            <a href="{{ url('/home/' . $post->id . '/edit') }}" class="btn btn-primary btn-sm float-right btn-white-color" role="button" >@lang('messages.edit')</a>
                        </div>
                ...
                <div class="card-body card-border">
                    <div class="row">
                        ...
                        <div class="col lesspadding">
                            <a role="button" class="btn btn-twit btn-sm share" href="https://twitter.com/share?url={{ url('/posts/' . $post->post_slug)}}&via={!! env('TWITTER_USERNAME') !!}" target="_blank"><i class="icon-social-twitter icons"></i> <span class="d-none d-md-inline-block">@lang('messages.share')</span></a>
                        </div>
                    </div>   
                </div>
