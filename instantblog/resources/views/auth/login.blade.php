...
<div class="container text-white">
    <div class="row">
        <div class="col-md-4">
            <form class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}">
                ...
                <div class="checkbox">
                    ...
                    <a href="{{ url('/register') }}"><strong> @lang('messages.login.sign')</strong></a>
                    </label>
                </div>
                <div class="checkbox">
                    <label>
        ...
        <div class="col-md-4 pt-4">
             ...
             <div class="sociallogin">
                <a role="button" class="btn btn-twit social" href="{{ url('/auth/twitter') }}" ><i class="icon-social-twitter icons"></i>@lang('messages.login.twitter')</a>
            </div>
             <div class="sociallogin">
