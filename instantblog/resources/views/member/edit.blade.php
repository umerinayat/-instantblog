...
<div class="container">
    ...
    @if ($post->user_id == Auth::id() OR Auth::user()->is_admin)
    ...
    <div class="alert alert-warning" role="alert">
      <strong>@lang('messages.form.nofound')</strong> @lang('messages.form.backto') <a href="{{ url('/') }}">@lang('messages.form.hometxt')</a>.
    </div>
    @endif
    </div>
</div>
